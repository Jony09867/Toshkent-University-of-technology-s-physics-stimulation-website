...
const brand = () =>
  `<a class="brand" href="#/" aria-label="${uz.homeBrand}"><span class="tt-mark">TT</span><span class="brand-name"><b><em>TASHKENT</em> UNIVERSITY<br>OF <em>TECHNOLOGY</em></b><small>PHYSICS LAB</small></span></a>`;
