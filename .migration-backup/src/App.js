...
const brand = () =>
  `<a class="brand" href="#/" aria-label="${uz.homeBrand}"><svg class="tt-logo-mark" viewBox="0 0 84 56" aria-hidden="true"><path d="M8 0h27l6 12.5H25.5V56H13.5V12.5H0L8 0z" fill="#F1592A"/><path d="M50 0h27l6 12.5H67.5V56H55.5V12.5H42L50 0z" fill="#F1592A"/></svg><span class="brand-name"><span class="brand-logo-text"><span class="brand-line-main"><span class="solid">TASHKENT </span><span class="outline">UNIVERSITY</span></span><span class="brand-line-main"><span class="outline">OF TECH</span><span class="solid">NOLOGY</span></span></span><small class="brand-sub">PHYSICS LAB</small></span></a>`;
