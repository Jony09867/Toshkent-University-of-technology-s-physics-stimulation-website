...
- **KaTeX 0.16.22** — MIT. Distributed files in `public/vendor/katex/`; full license in `public/vendor/licenses/KaTeX.txt`. Source: https://github.com/KaTeX/KaTeX/tree/v0.16.22
- **Chart.js 4.4.9** — MIT. `public/vendor/chart.umd.js`; full license in `public/vendor/licenses/Chart.js.txt`. Source: https://github.com/chartjs/Chart.js/tree/v4.4.9
